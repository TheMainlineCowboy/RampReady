...
test("isolates the pre-server PHX concrete layer in the A1 chase view", async ({ page }) => {
  ...
  await captureCanvas(page, canvas, "kphx-ground-diagnostic-concrete-hidden-pre-server.png");
});
