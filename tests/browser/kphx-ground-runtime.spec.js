...
test("loads source-correct PHX scenery with the complete uploaded Terminal 4 jetway fleet and pavement-coincident markings", async ({ page }) => {
  ...
  expect(runtime.terminal4UploadedJetwayReadyAuthority).toBe("uploaded-airport-jetway-fleet-complete-58-gates-v6-instanced-source-textured");
  ...
  expect(runtime.terminal4JetwaySourceGeometryMode).toBe("user-supplied-airport-jetway-tunnel-a-b-c-rotunda-cab-v4-instanced-static-source-textured");
