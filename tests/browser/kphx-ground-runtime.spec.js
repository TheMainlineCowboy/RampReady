...
test("loads source-authored textured PHX Terminal 4 at decoded A1 over airport-wide ground", async ({ page }) => {
  ...
  await expectRuntimeValue(canvas, "data-kphx-detail-level", "terminal4-authored-textured-v1");
  ...
  await writeFile("test-results/kphx-source-authored-terminal4.png", image);
});
