...
console.log(`Prepared ${marker}: four largest live suspended A1 support lower ends receive separate pavement-buried sleeves; supplied GLB geometry remains byte-for-byte untouched.`);
