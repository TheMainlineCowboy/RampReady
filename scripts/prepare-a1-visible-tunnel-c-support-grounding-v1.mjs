...
const marker = "a1-visible-tunnel-c-support-grounding-runtime-v7-fleet-parent-ramp";
...
console.log(`Prepared ${marker}: all five visible Tunnel-C support islands use the transformed fleet-parent ramp plane already owned by exact A1 bogie grounding.`);
