...
console.log(`Prepared ${marker}: final A1 browser geometry telescopes the two disconnected exact-source Tunnel-C bogie/support pods to the ramp after service-stair clearance, preserving their upper mounts and wheel/base shapes without moving the passenger shell, aircraft, terminal, Rotunda or Cab.`);
