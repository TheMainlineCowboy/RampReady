...
console.log(`Prepared ${marker}: final A1 browser geometry grounds disconnected exact-source Tunnel-C support islands on the ramp after service-stair clearance, without moving the passenger shell, aircraft, terminal, Rotunda or Cab.`);
