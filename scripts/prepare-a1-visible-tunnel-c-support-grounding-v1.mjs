...
const marker = "a1-visible-tunnel-c-support-grounding-runtime-v12-mixed-vertex-branch-scan";
...
for (const oldMarker of [
  ...
  "a1-visible-tunnel-c-support-grounding-runtime-v9-rendered-suspended-set",
  "a1-visible-tunnel-c-support-grounding-runtime-v10-complete-pavement-scan",
  "a1-visible-tunnel-c-support-grounding-runtime-v11-crossing-branch-scan",
]) {
...
for (const required of [
  ...
  importLine,
  authority,
  "rendered-kphx-source-aerial-raycast-under-whole-and-mixed-vertex-support-branches",
  `finalA1VisibleSupportGrounding.inspectedCandidateCount !== ${EXPECTED_INSPECTED_COMPONENT_COUNT}`,
  `finalA1VisibleSupportGrounding.groundedComponentCount !== ${EXPECTED_WHOLE_SUSPENDED_COMPONENT_COUNT}`,
  `finalA1VisibleSupportGrounding.groundedTriangleCount !== ${EXPECTED_WHOLE_SUSPENDED_TRIANGLE_COUNT}`,
  `finalA1VisibleSupportGrounding.buriedCandidateCount !== ${EXPECTED_BURIED_COMPONENT_COUNT}`,
...
for (const forbidden of [
  'exact-supplied-tunnel-c-visible-support-components-grounded-v13-rendered-pavement-branch-scan',
  'a1-visible-tunnel-c-support-grounding-runtime-v11-crossing-branch-scan',
]) {
...
console.log(`Prepared ${marker}: mixed pavement-crossing Tunnel-C hardware is split by connected above-pavement source vertices, then every visible support branch is telescoped to rendered KPHX pavement with its upper mount fixed.`);
