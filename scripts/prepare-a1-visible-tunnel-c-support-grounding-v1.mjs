...
const marker = "a1-visible-tunnel-c-support-grounding-runtime-v10-complete-pavement-scan";
...
// Exact-head rendered-pavement classification of the supplied Tunnel-C mesh.
// All 25 compact aircraft-side component islands must be inspected. Of those,
// exactly five are wholly suspended above the rendered ramp and therefore need
// telescoping; those five contain 590 triangles. Twelve candidates are wholly
// below the visible pavement and eight already cross it. Buried/crossing geometry
// may never be promoted into the visible suspended-support identity.
const EXPECTED_INSPECTED_COMPONENT_COUNT = 25;
const EXPECTED_SUSPENDED_COMPONENT_COUNT = 5;
const EXPECTED_SUSPENDED_TRIANGLE_COUNT = 590;
...
console.log(`Prepared ${marker}: inspected all 25 compact Tunnel-C islands; exactly five suspended islands (590 triangles) must be seated on rendered KPHX pavement, with 12 buried and 8 crossing candidates kept out of visible-support acceptance.`);
