...
console.log(`Prepared ${marker}: final A1 browser geometry grounds every compact visible exact-source Tunnel-C load-bearing support island to the derived KPHX ramp envelope, rejects any remaining suspended support, and preserves upper mounts plus the passenger shell.`);
