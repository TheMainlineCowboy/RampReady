...
const marker = "a1-visible-tunnel-c-support-grounding-runtime-v13-spatial-rod-clusters";
...
for (const oldMarker of [
  ...
  "a1-visible-tunnel-c-support-grounding-runtime-v12-mixed-vertex-branch-scan",
]) {
