...
const marker = "a1-visible-tunnel-c-support-grounding-runtime-v8-rendered-pavement-raycast";
...
for (const forbidden of [
  ...
  'transformed-uploaded-a1-gate-anchor-local-y0',
  'transformed-uploaded-a1-fleet-parent-local-y0',
...
console.log(`Prepared ${marker}: all five visible Tunnel-C support islands are seated against direct raycasts of the rendered KPHX source-aerial pavement.`);
