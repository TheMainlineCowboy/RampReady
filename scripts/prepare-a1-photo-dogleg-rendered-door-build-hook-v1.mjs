...
const marker = "a1-photo-dogleg-rendered-door-build-hook-v11-final-visible-normalization";
...
console.log(`Installed ${marker}: final Vite bundling binds A1's photo dogleg/remote Rotunda, physically fits the exact supplied movable bridge to the visible grounded CRJ door, normalizes the integrated Tunnel-C support carrier and inspection framing, then runs strict final-world evidence without moving Terminal 4 or the aircraft.`);
