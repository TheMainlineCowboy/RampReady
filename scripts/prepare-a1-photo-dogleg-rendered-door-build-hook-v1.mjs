...
const marker = "a1-photo-dogleg-rendered-door-build-hook-v14-fixed-aircraft-exact-door";
...
console.log(`Installed ${marker}: final Vite bundling preserves the A1 photo dogleg/remote Rotunda, fits the exact supplied movable bridge to the exact authored CRJ forward-left door while the aircraft stays fixed, preserves Tunnel-C as one continuous passenger tunnel, validates supplied service-stair clearance, refreshes bogie/camera evidence, then runs strict final-world verification.`);
