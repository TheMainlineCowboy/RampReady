...
const marker = "a1-photo-dogleg-rendered-door-build-hook-v18-first-passenger-threshold-gap";
...
console.log(`Installed ${marker}: final Vite bundling preserves A1's photo dogleg/remote Rotunda, keeps the exact CRJ fixed, targets the exact authored forward-left door, preserves Tunnel-C as one continuous supplied passenger tunnel, removes the obsolete mechanical-minimum Cab pre-lift, uses the first physical passenger-threshold gap, fits the supplied Cab sill/hood to the door, validates supplied service-stair/bogie clearance, and then runs strict final-world verification.`);
