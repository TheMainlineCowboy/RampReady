...
console.log(`Installed ${marker}: final Vite bundling binds A1's fixed corridor and browser telemetry to the explicit BGATE1 facade/final remote Rotunda, then physically articulates only the exact supplied movable bridge to the CRJ door, re-grounds Tunnel-C support subsets, rebases attached deployment, validates the bogie footprint, and leaves Terminal 4, aircraft, Airport_Jetway.glb geometry/textures, and A3+ short/direct connectors untouched.`);
