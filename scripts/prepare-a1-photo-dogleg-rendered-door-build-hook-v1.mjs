...
console.log(`Installed ${marker}: final Vite bundling binds A1's photo dogleg/remote Rotunda, physically fits the exact supplied movable bridge to the visible grounded CRJ door, preserves the integrated Tunnel-C passenger carrier as one continuous tunnel, clears only the measured supplied service-stair triangle subset from the aircraft, refreshes bogie/camera evidence, then runs strict final-world verification without moving Terminal 4 or the aircraft.`);
