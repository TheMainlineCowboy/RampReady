...
console.log(`Installed ${marker}: final Vite bundling preserves the A1 photo dogleg/remote Rotunda, fits the exact supplied movable bridge to the exact authored CRJ forward-left door while the aircraft stays fixed, preserves Tunnel-C as one continuous passenger tunnel, proves final Cab/door contact from the exact transformed hood footprint, validates supplied service-stair clearance, refreshes bogie/camera evidence, then runs strict final-world verification.`);
