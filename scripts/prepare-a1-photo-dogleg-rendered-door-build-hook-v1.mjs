...
for (const required of [
  ...
  "prepare-a1-reference-dogleg-orientation-v3.mjs",
  ...
  "prepare-a1-neutralize-stale-cab-prelift-v1.mjs",
  "prepare-a1-final-cab-sill-surface-fit-v1.mjs",
  "prepare-a1-select-lowest-cab-passenger-split-v1.mjs",
  ...
  "prepare-final-fleet-pavement-registration-v4.mjs",
...
console.log(`Installed ${marker}: final Vite bundling preserves A1's photo dogleg/remote Rotunda, applies the corrected terminal/opposite-side elbow orientation from the Aug. 15 overhead, keeps the exact CRJ fixed, targets the exact authored forward-left door, grounds A1 from the primary visible Tunnel-C bogie mass instead of hidden low fragments, preserves Tunnel-C as one continuous supplied passenger tunnel, validates supplied service-stair/bogie clearance, and then runs strict final-world verification.`);
