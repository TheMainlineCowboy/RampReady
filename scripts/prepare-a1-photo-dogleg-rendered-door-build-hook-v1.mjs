...
const marker = "a1-photo-dogleg-rendered-door-build-hook-v12-aircraft-side-stair-clearance";
...
console.log(`Installed ${marker}: final Vite bundling binds A1's photo dogleg/remote Rotunda, physically fits the exact supplied movable bridge to the visible grounded CRJ door, rigidly clears the measured supplied service stair from the aircraft at the last geometry stage, refreshes bogie/camera evidence, then runs strict final-world verification without moving Terminal 4 or the aircraft.`);
