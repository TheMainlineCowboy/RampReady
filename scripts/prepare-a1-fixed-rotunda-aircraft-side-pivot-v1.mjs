...
console.log("Prepared A1 as one intact supplied Airport_Jetway.glb assembly: measured terminal-wall Rotunda position is preserved, the complete parent receives decoded KPHX heading, and no Tunnel A/B/C/Cab child is reparented or independently yawed. Final terminal-wall seam depth is normalized only after rendered cleanup, immediately before production camera/bundling stages.");
