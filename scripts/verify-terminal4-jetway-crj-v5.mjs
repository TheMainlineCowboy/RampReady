...
if (!packageJson.scripts?.["prepare:terminal4-runtime"]?.includes("prepare-terminal4-inspection-controls.mjs")) {
  throw new Error("Terminal 4 runtime does not apply the post-generation inspection controls");
}
...
console.log("Terminal 4 CRJ v5 verified: CRJ-scale jetways and A1 contact, source-qualified service bays, irregular lower facade, pavement-coincident markings, and visible free-drive inspection controls.");
