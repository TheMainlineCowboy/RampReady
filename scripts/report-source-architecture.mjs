...
const trackedRequirements = [
  ...
  ["reverse stop target", "const STOP_Z = -39.6;"],
  ["reverse remaining-distance calculation", "const stopRemaining = sim.aircraft.position.z - STOP_Z;"],
  ["reverse completion gate", "if (towActive && sim.aircraft.position.z <= STOP_Z + 0.5) {"],
  ["full reverse-route ramp", "new THREE.PlaneGeometry(90, 140)"],
  ["full reverse-route centerline", "new THREE.PlaneGeometry(0.16, 130)"],
