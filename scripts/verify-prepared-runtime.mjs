...
// the final jetway readiness and the A1 evidence camera only after that
// preparation has been verified, so no later runtime preparer can restore the
// retired compact A1/static readiness or reject the real ~20 m wall/Rotunda
// span before Vite bundles the production scene.
