...
console.log("Finalized Terminal 4 with the source-measured A1 real-wall/Rotunda geometry and grounded aircraft/bogie evidence, plus rigid exact-GLB static jetways registered from their authored Rotundas to measured terminal facade walls. Synthetic static Cab closure boxes and compact 2.4 m A1 geometry are not acceptance criteria.");
