...
const replacements = [
  ...
  ["const STOP_Z = 52;", "const STOP_Z = -39.6;"],
  ["stop: STOP_Z - NOSE_START_Z", "stop: NOSE_START_Z - STOP_Z"],
  ["const stopRemaining = STOP_Z - sim.aircraft.position.z;", "const stopRemaining = sim.aircraft.position.z - STOP_Z;"],
