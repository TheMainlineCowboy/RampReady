...
// Do not apply the retired hard-coded A14 -10 degree corner rotation here.
// The A12/A14 exact-envelope diagnostic must start from the unmodified
// airport-derived wall registration and own-parking geometry.
