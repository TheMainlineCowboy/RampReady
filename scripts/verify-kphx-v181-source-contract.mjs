...
for (const token of [
  ...
  "dataset.kphxExactLiveT4",
  "dataset.kphxExactLiveT4BuildingCount",
  "dataset.kphxExactLiveT4JetwayCount",
  "dataset.kphxExactLiveT4JetwayOpenEdgeCount",
  "dataset.kphxExactLiveOldAirportJetwayGlbUsed",
  "dataset.b15Anchors",
