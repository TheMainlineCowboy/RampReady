...
console.log(`Prepared ${marker}: Cab-only articulation is limited to <=0.15 m; larger residuals fail so the connected bridge/support geometry must be corrected.`);
