...
for (const required of [
  ...
  "cabDoorLaterallyCovered",
  "cabDoorVerticallyCovered",
  "inspectionAircraftCabDoorContactAuthority",
...
for (const forbidden of [
  ...
  "dataset.inspectionAircraftCabDoorContactAuthority = marker",
]) {
  if (source.includes(forbidden)) throw new Error(`${path}: stale centroid/aircraft-motion/unserialized Cab proof survived: ${forbidden}`);
}
