...
console.log(`Prepared ${marker}: generation-order-safe scoped Cab face/hood proof enforces the fixed CRJ door without moving airport, aircraft or jetway geometry.`);
