...
console.log(`Prepared ${SUPPORT_AUTHORITY}: A1 now has exactly two permanent ramp-supported columns under the fixed final approach before the remote Rotunda/movable wheel-supported jetway; Airport_Jetway.glb remains untouched.`);
