...
console.log(`Prepared active trainer with the source-authored textured PHX Terminal 4, exact ADEX A1 registration, unrotated airport ground and equipment routing: ${path.relative(root, outputPath)}`);
