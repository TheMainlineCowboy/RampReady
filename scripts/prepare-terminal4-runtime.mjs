...
console.log(`Prepared active trainer with the source-authored textured PHX Terminal 4, unrotated A1-local airport ground and equipment routing: ${path.relative(root, outputPath)}`);
