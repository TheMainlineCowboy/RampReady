...
// source scale and CRJ door/contact geometry here. The exact placement fields,
// fleet installer call and all 58 gate records remain enforced by the later
// post-wiring fleet and articulation verifiers.
for (const token of [
...
console.log("Verified early exact Airport Jetway alignment: airport scale remains 1.00, the CRJ forward-left door uses 7.32 m aft and 1.34 m left offsets, and the supplied 2.61 m contact assembly reaches the aircraft without shrinking the model. All 58 exact placement records are verified after source wiring.");
