...
if (!source.includes(marker)) {
  ...
  const runtimeBlock = [
    ...
    "  }",
    "",
    "  const correctedCabSideWorld = new THREE.Vector3(-resolvedCabSurface.doorward.z, 0, resolvedCabSurface.doorward.x).normalize();",
