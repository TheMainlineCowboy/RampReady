...
const marker = "a1-final-supplied-cab-door-facing-sill-surface-fit-v1";
...
console.log(`Prepared ${marker}: final exact supplied Cab threshold is derived from its real aircraft-facing surface, vertically articulated to the fixed authored CRJ door sill within 2 cm, and required to remain connected to Tunnel-C.`);
