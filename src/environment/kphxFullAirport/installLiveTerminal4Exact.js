...
export async function installKphxExactLiveTerminal4(THREE, environment) {
  ...
  environment.userData = {
    ...
    authoredTerminal4JetwayInitialState: "exact-authored-static",
    authoredTerminal4RequiredPrePushSequence: "none-static-exact-source",
    authoredTerminal4A1JetwayController: null,
    authoredTerminal4A1JetwayAnimationAuthority: "not-yet-wired-live; static exact source retained",
    ...
    authoredTerminal4UploadedJetwayArticulationAuthority: "exact-authored-static-source",
