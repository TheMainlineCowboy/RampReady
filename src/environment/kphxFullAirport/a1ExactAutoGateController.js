...
export function installA1ExactAutoGateController({
  ...
  function setDeployment(value) {
    ...
    // The raw AutoGate OBJ contains nested vertical transforms. Applying the
    // dataref as a translation of this entire stock facade wall double-counted
    // that motion and dragged the exact wheel/support assembly below pavement.
    // Keep the ZIP-authored Wall-5 Y position fixed and retain the original
    // intact pitch/telescope/cabin articulation from this controller.
  ...
  root.userData.a1AutoGateControllerAuthority =
    "exact-first-intact-A1-articulation-with-no-whole-wall-vertical-translation-v9";
