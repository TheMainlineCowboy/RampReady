...
function frameRampView(camera, terminalLayer, jetwayLayer, jetwayMap, view) {
  ...
  const closeGateQa = view === "A1" || view === "A14" || view === "A30" || view === "B2" || view === "B14" || view === "B28" || view === "C1" || view === "C9" || view === "C19" || view === "D1" || view === "D4";
  const tightGateFaceQa = view === "A14" || view === "A30" || view === "B2" || view === "B14" || view === "B28" || view === "C1" || view === "C9" || view === "C19" || view === "D1" || view === "D4";
  const bGateFarQa = view === "B2" || view === "B14";
  const cGateFarQa = view === "C1";
  const c9TightQa = view === "C9" || view === "C19";
  const dGateQa = view === "D1" || view === "D4";
