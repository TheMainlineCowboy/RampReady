...
import RampReadyTrainerStable from "./RampReadyTrainerStable.jsx";
...
export default function PushbackTrainer() {
  ...
  return (
    <>
      <RampReadyTrainerStable />
      {gyroAvailable && (
        <button
          type="button"
          aria-pressed={gyroEnabled}
          onClick={gyroEnabled ? stopGyro : startGyro}
          style={{
            position: "fixed",
            ...
            borderRadius: 10,
            background: gyroEnabled ? "rgba(20,110,58,0.92)" : "rgba(17,24,39,0.88)",
            color: "white",
            fontWeight: 700,
            padding: "10px 14px",
