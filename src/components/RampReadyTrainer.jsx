...
export default function RampReadyTrainer() {
  ...
  const advance = () => {
    ...
    if (stageIndex === 5) setTrainerMessage("Scenario complete.");
    setStageIndex((old) => {
  ...
  return (
    <div className="rr-shell">
      ...
      {showDiagnostics && <aside style={{ position: "absolute", left: 8, right: 104, bottom: "calc(174px + env(safe-area-inset-bottom))", zIndex: 6, padding: "6px 8px", borderRadius: 10, background: "rgba(0,0,0,0.58)", color: "#d7ffb8", fontSize: 10, fontFamily: "ui-monospace, monospace" }}>{hud.debug}</aside>}
